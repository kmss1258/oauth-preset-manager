...
- 피크 시간은 UTC 01:00–04:00 / KST 10:00–13:00, UTC 06:00–10:00 / KST 15:00–19:00입니다. 시작 1시간 전부터 `HH:MM:SS` 카운트다운을 표시하고, 피크 중에는 TTY 화면의 테두리가 파스텔 무지개색으로 회전합니다.
- 현재 프리셋에만 있는 OAuth 인증을 다른 프리셋에 덮어쓰지 않고 일괄 추가할 수 있으며, OpenAI kickoff에는 `gpt-5.6-luna`를 사용합니다.
