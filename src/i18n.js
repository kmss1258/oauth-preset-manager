...
const TRANSLATIONS = {
  ko: {
    ...
    propagate_oauth: '현재 프리셋 OAuth 전체 배포',
    ...
    quota_auto_refresh_countdown: '{seconds}초 후 자동 새로고침',
    quota_peak_active: '피크 모드 활성 · {duration} 후 종료',
    quota_peak_pre_alert: '피크 진입 주의 · {duration} 후 시작',
    quota_peak_off: '피크 어림 없음 · 평일(월–금)만: UTC 01:00–04:00, 06:00–10:00 / ☀️ KST 10:00–13:00, 🏢 KST 15:00–19:00 · 주말 휴무',
  ...
  en: {
    ...
    propagate_oauth: 'Propagate Current Preset OAuth',
    ...
    quota_auto_refresh_countdown: 'Auto-refresh in {seconds}s',
    quota_peak_active: 'Peak mode active · ends in {duration}',
    quota_peak_pre_alert: 'Peak entry warning · starts in {duration}',
    quota_peak_off: 'Peak not imminent · Monday-Friday only: UTC 01:00–04:00, 06:00–10:00 / ☀️ KST 10:00–13:00, 🏢 KST 15:00–19:00 · weekends off',
