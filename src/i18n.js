...
const TRANSLATIONS = {
  ko: {
    ...
    oauth_propagate_confirm: "현재 프리셋 '{name}'의 없는 OAuth 인증을 다른 프리셋에 추가할까요?",
    oauth_propagate_complete: 'OAuth 인증 배포가 완료되었습니다.',
    oauth_propagate_changed: '변경된 프리셋',
    oauth_propagate_skipped: '이미 존재하여 건너뜀',
    oauth_propagate_conflicts: '충돌로 건너뜀',
    ...
    quota_peak_off: '피크 어림 없음 · 일정: UTC 01:00–04:00, 06:00–10:00 / ☀️ KST 10:00–13:00, 🏢 KST 15:00–19:00',
  ...
  en: {
    ...
    oauth_propagate_confirm: "Add missing OAuth credentials from '{name}' to the other presets?",
    oauth_propagate_complete: 'OAuth propagation completed.',
    oauth_propagate_changed: 'Changed presets',
    oauth_propagate_skipped: 'Skipped because already present',
    oauth_propagate_conflicts: 'Skipped due to conflicts',
    ...
    quota_peak_off: 'Peak not imminent · Schedule: UTC 01:00–04:00, 06:00–10:00 / ☀️ KST 10:00–13:00, 🏢 KST 15:00–19:00',
